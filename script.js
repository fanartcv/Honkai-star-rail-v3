...
(function() {
    ...
    const characterData = {
        castorice: {
            name: 'Castorice',
            lore: 'Welcome to Okhema. I am Castorice. Apologies, it is my habit to keep my distance from others... I can get closer if you wish, however.'
        },
        cyrene: {
            name: 'Cyrene',
            lore: 'Is this a meeting ordained by fate, or... a long-overdue reunion? It s making my heart beat faster. Then... please once again call me "Cyrene," just like when we met the first time, okay.'
        },
        hyacine: {
            name: 'Hyacine',
