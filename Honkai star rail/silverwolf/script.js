...
(function() {
    ...
    const characterData = {
        castorice: {
            name: 'Castorice',
            lore: 'Castorice adalah karakter misterius yang memiliki kekuatan luar biasa untuk memanipulasi waktu dan ruang. Sebagai anggota Astral Express, dia membawa ketenangan di tengah badai kosmik.'
        },
        cyrene: {
            name: 'Cyrene',
            lore: 'Cyrene adalah prajurit tangguh yang berdedikasi melindungi teman-temannya. Dengan pedang legendaris yang diturunkan dari generasi ke generasi, dia tidak pernah mundur dari pertempuran.'
        },
        hyacine: {
            name: 'Hyacine',
            lore: 'Hyacine adalah seorang ilmuwan brilian yang meneliti fenomena kosmik. Keingintahuannya tentang alam semesta membuatnya menjadi aset berharga bagi Astral Express dalam menjelajahi galaksi yang tak terjamah.'
        }
    };
    ...
    function initLoadingScreen() {
        ...
        // Method 1: Hide after DOMContentLoaded (paling cepat)
        ...
        // Method 2: Backup timer - pasti hilang setelah 1.5 detik
        setTimeout(hideLoadingScreen, 1500);

        // Method 3: Hide setelah window.load (semua resources loaded)
    ...
    function initAudio() {
        ...
        DOM.audioToggle.addEventListener('click', async () => {
            ...
            try {
                ...
                alert('Tidak bisa memutar audio. Pastikan file audio/cyrene_theme.mp3 ada.');
            }
        });

        DOM.bgMusic.addEventListener('error', (e) => {
            console.error('Audio loading error:', e);
            console.error('Audio src:', DOM.bgMusic.src);
        });
        ...
        DOM.bgMusic.addEventListener('canplay', () => {
            console.log('Audio ready to play');
        });

        console.log('Audio initialized:', DOM.bgMusic.src);
    }
    ...
    function initProfileZoom() {
        ...
        DOM.profileImg.addEventListener('click', (e) => {
            e.stopPropagation();
            DOM.profileImg.classList.toggle('zoomed');
        });
